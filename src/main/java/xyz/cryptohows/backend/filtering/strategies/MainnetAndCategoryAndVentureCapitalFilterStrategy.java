...
public class MainnetAndCategoryAndVentureCapitalFilterStrategy extends FilterStrategy {
    ...
    public Long countAllRounds(List<Mainnet> mainnets, List<Category> categories, String ventureCapitalInput) {
        ...
        return roundParticipationRepository.countRoundsFilterMainnetAndCategoryAndVentureCapitals(mainnets, categories, ventureCapitals);
    }
    ...
    public List<Round> findRounds(String order, Integer page, Integer roundsPerPage, List<Mainnet> mainnets, List<Category> categories, String ventureCapitalInput) {
        ...
        if ("old".equals(order)) {
            return roundParticipationRepository.findRoundsFilterMainnetAndCategoryAndVentureCapitalsOrderByOlderRound(pageable, mainnets, categories, ventureCapitals);
        }
        return roundParticipationRepository.findRoundsFilterMainnetAndCategoryAndVentureCapitalsOrderByRecentRound(pageable, mainnets, categories, ventureCapitals);
    }

    @Override
    public Long countAllProjects(List<Mainnet> mainnets, List<Category> categories, String ventureCapitalInput) {
        List<String> ventureCapitals = parseVentureCapitalInput(ventureCapitalInput);
        return partnershipRepository.countProjectFilterMainnetAndCategoryAndVentureCapitals(mainnets, categories, ventureCapitals);
    }
    ...
    public List<Project> findProjects(Integer page, Integer projectsPerPage, List<Mainnet> mainnets, List<Category> categories, String ventureCapitalInput) {
        ...
        return partnershipRepository.findProjectsFilterMainnetAndCategoryAndVentureCapitalsOrderByIdDesc(pageable, mainnets, categories, ventureCapitals);
    }
}
